...
local function extend_or_override(config, custom_config, key)
  ...
  if key ~= nil then
    ...
    if type(custom_config[key]) == "table" then
      config[key] = vim.tbl_deep_extend("force", config[key] or {}, custom_config[key])
    else
